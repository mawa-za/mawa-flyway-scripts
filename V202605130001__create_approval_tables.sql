...
CREATE TABLE approval_workflow (
    ...
    -- CLAIM, PAYMENT, LEAVE, CASHUP, INVOICE, etc.
...
CREATE TABLE approval_workflow_step (
    ...
    -- user id, role code, group id, etc.

    required_approvals  INT NOT NULL DEFAULT 1,
    -- useful if a step requires 2 managers from same role/group
    ...
    INDEX idx_workflow_step_approver (approver_type, approver_value)
)ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8mb3
  COLLATE = utf8mb3_general_ci;
...
CREATE TABLE approval_request (
    ...
    -- claim id, payment batch id, leave id, etc.
